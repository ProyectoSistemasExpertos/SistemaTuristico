...
INSERT INTO `person` (`idPerson`, `idCard`, `namePerson`, `firstLastNamePerson`, `secondLastNamePerson`, `personPhone`, `personAddress`, `personEmail`, `personPassword`, `rolDescription`, `token`)
 ...
 INSERT INTO `preference` (`idPreference`, `idPerson`, `idCategory`) VALUES ('4', '1', '1');
  INSERT INTO `booking` (`idBooking`, `description`, `state`, `price`, `location`, `totalPossibleReservation`, `idPerson`) VALUES
 ('1', 'Cabo Verde', '0', '12000', 'Limon', '5', '1');
 INSERT INTO `housing` (`idHousing`, `initial_date`, `final_date`, `arrival_date`, `total_person`, `idPerson`,`idBooking`) 
 VALUES ('1', '2024-01-01', '2024-01-03', '2024-01-01', '2', '1','1');
