        ...
        <div class="row">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('booking.filter_by_category', '1')); ?>" >
                                Montaña
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo e(route('booking.filter_by_category', '2')); ?>">
                                Playa
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"  href="<?php echo e(route('booking.filter_by_category', '3')); ?>" data-value="3">
                                Ciudad
                            </a>
                        </li>
                    </ul>
...
</html><?php /**PATH C:\ProyectoInformatica\Backend\resources\views/body/sidebar.blade.php ENDPATH**/ ?>