...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo e(asset('backend/assets/dist/img/logo.gif')); ?>" alt="AdminLTELogo" height="90" width="90">
  </div>-->

    <!-- Navbar -->
    <?php echo $__env->make('body.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- /.navbar -->
...
</html><?php /**PATH C:\ProyectoInformatica\Backend\resources\views/body/master_body.blade.php ENDPATH**/ ?>